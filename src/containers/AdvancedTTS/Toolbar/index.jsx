...
import { AUDIO_TYPE, BITRATE, TTS_ATTRIBUTE } from '@src/constants/voice';
import {
  EditorState,
  CompositeDecorator,
  Modifier,
...
import EmphasisImg from '@src/assets/images/emphasis.png';
...
import { handleSelectedElement } from '@src/services/paragraph';
...
const Toolbar = ({
  ...
  const { synthesisRequest, paragraphs, selectedParagraph } = useSelector(
  ...
  return (
    <StyledToolbar>
      ...
      <div className="action border-right">
        ...
        >
          <img src={EmphasisImg} alt="emphasis" className="button-img" />
          <Typography variant="body2" className="button-text">
            {t('emphasis')}
          </Typography>
        </div>
